...
const ARTISTS_DATA = [
  ...
  { name: "Jei", role: ["Writer", "DJ", "Producer", "Vocalist"], img: "jei.jpg", accent: "indigo", bio: "Bio coming soon." },
...
const OFFICIAL_RELEASES_DATA = [
  { artist: "Marilyn Torres", title: "Forgive Me***", type: "EP (4 Tracks)", art: "https://distrokid.imgix.net/http%3A%2F%2Fgather.fandalism.com%2F2439182--5D73E809-F785-4433-8CBC1CC3A83D36C0--0--15224287--ForgiveMeCover.png?fm=jpg&q=75&w=800&s=62dbd8cfc4a49938e44a691c33bcec52" },
                      ...
                      >
                        ...
                        {/* Badges */}
                          {release.title.includes('***') ? (
                            <div className="absolute top-4 left-4 bg-indigo-500 text-white px-2.5 py-1 rounded text-[9px] font-bold uppercase tracking-widest z-20 shadow-lg">
                              Coming Soon
                            </div>
                          ) : release.title.includes('**') ? (
