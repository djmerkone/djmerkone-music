...
const App = () => {
  ...
  const artists = [
    ...
    { 
      ...
      img: "/dengbio.jpg",
      accent: "rose",
      bio: "Dengel represents the cutting edge of contemporary Latin and Urban sounds. His sharp lyrical delivery and ear for modern hooks make him a cornerstone of the djmerkone MUSIC writing team.",
    ...
    <div className="min-h-screen bg-[#030303] text-zinc-100 font-sans selection:bg-red-500/30 overflow-x-hidden">
      ...
      <section id="production" className="relative h-screen flex items-center justify-center px-10 schmear-bg overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-7xl">
          ...
          <h1 className="hero-text uppercase mb-12">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-12 mt-20">
            ...
            <p className="max-w-md text-sm font-medium uppercase tracking-[0.2em] leading-loose text-zinc-400 text-left border-l border-white/10 pl-8 italic">Established 2019. We fuse the raw energy of <span className="text-white">Hip-hop & Latin</span> with the refined clarity of <span className="text-white">EDM, Soul & Blues</span>.</p>
          </div>
        </div>
      </section>
      ...
      <section id="roster" className="py-40 px-8 md:pl-40 md:pr-24 relative">
        <div className="flex flex-col lg:flex-row justify-between items-end mb-32 border-b border-white/5 pb-12">
          <div className="max-w-xl">
            <h2 className="text-[10vw] md:text-8xl font-black uppercase tracking-tighter leading-none mb-6">
      ...
      <section id="studio" className="py-40 px-8 md:pl-40 md:pr-24 hub-bg relative border-y border-white/5">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10">
           <div className="lg:col-span-5 p-16 border border-white/10 bg-black/70 backdrop-blur-xl rounded-[3rem] h-full flex flex-col justify-between hover:border-red-500/30 transition-all group">
              ...
              <div>
                <h3 className="text-6xl font-black uppercase italic mb-10 tracking-tighter">
      ...
      <section id="work" className="py-40 px-8 md:pl-40 md:pr-24 border-t border-white/5 bg-[#030303]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-32">
          <div className="sticky top-32">
             ...
             <h2 className="text-7xl md:text-8xl font-black uppercase tracking-tighter leading-none mb-10 italic">
             ...
             {releases.map((track, i) => (
               <div key={i} className="group flex items-center p-8 border border-white/5 bg-zinc-950/50 hover:bg-white/5 transition-all">
                  ...
                  <div className="flex-grow">
                    <h5 className="text-xl font-bold uppercase group-hover:text-red-500 tracking-tight">
          ...
          <div className="grid grid-cols-2 gap-20">
            <div>
              ...
              <ul className="space-y-4 text-xs font-black uppercase tracking-widest text-zinc-400 italic">
                <li><a href="https://luismartemusic.com" target="_blank" className="hover:text-red-500 flex items-center transition-colors">Luis Marte <ExternalLink size={12} className="ml-2" /></a></li>
                <li><a href="https://marilyn-site.vercel.app/" target="_blank" className="hover:text-red-500 flex items-center transition-colors">Marilyn Torres <ExternalLink size={12} className="ml-2" /></a></li>
                <li><a href="https://djmerkone-site0.vercel.app" target="_blank" className="hover:text-red-500 flex items-center transition-colors lowercase italic">djmerkone <ExternalLink size={12} className="ml-2" /></a></li>
              </ul>
            </div>
            <div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                  <div className="relative aspect-[4/5] bg-zinc-900 overflow-hidden rounded-[2rem]">
                    ...
                    <div className="absolute bottom-0 left-0 w-full p-8 bg-gradient-to-t from-black to-transparent">
                      <h3 className={`text-6xl font-black uppercase tracking-tighter italic ${modal.data.name === 'djmerkone' ? 'lowercase' : ''}`}>{modal.data.name}</h3>
                      ...
                      <div className="grid grid-cols-1 gap-6">
                        {modal.data.link && (
                          <a href={modal.data.link} target="_blank" className="flex items-center space-x-6 group">
                            ...
                            <span className="text-sm font-black uppercase tracking-widest italic underline decoration-zinc-800 group-hover:decoration-white transition-all underline-offset-8">
