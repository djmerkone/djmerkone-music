...
const ARTISTS_DATA = [
  ...
  { name: "Apoca", role: ["Artist", "Writer"], img: "apobio.jpg", accent: "purple", bio: "Ivan Justiniano, known to the Latin Urban world as Apocalypsis or \"El Apoca,\" is a trailblazing artist whose roots run deep in the foundational era of the reggaeton movement. Emerging from Jacksonville, Florida, in 1998, his journey is one of relentless evolution—from a local club pioneer to an internationally recognized solo artist and key driving force within the djmerkone MUSIC collective.\n\nEl Apoca’s musical career ignited when he united with Reinaldo \"Terrorista\" Santiago and djmerkone to form the groundbreaking group Los Archangeles. As true pioneers of the Latin Urban movement in Jacksonville, their gritty, authentic sound and commanding stage presence earned them the undisputed heavyweight title, \"Los que Controlan desde el Norte de la Florida\" (The ones in control from North Florida).\n\nA major turning point arrived in 2005. Following a two-year stint with Baila Latin Music (BLM), the group released the breakout track \"Esa Nena\" on the Face Off: Special Edition compilation. The song became a massive catalyst, opening doors and expanding their reach into critical markets across Florida, Texas, New York, New Jersey, and Puerto Rico. By 2006, the group rebranded into the powerhouse duo \"Apoca & Terro,\" carrying a fresh image and helping launch the foundational DMO Muzik label alongside djmerkone. During this definitive era, Apoca proved his mettle by sharing the stage with some of the most legendary figures in the genre, including Don Chezina, Alexis y Fido, Trebol Clan, Khriz y Angel, Noriega, and Fulanito.\n\nToday, El Apoca has stepped into a dynamic new chapter as a solo powerhouse. Leveraging his decades of stage experience and sharp lyrical prowess, he has forged powerful new industry connections and vastly expanded his global footprint. Moving beyond his early duo roots, his solo projects and high-profile collaborations have garnered significant radio play and led to electrifying live performances across Puerto Rico, New York, Florida, the Dominican Republic, and throughout Latin America.\n\nNow officially partnered with djmerkone MUSIC, El Apoca is seamlessly bridging the gap between his pioneer roots and the modern Latin Urban landscape. Armed with a refined sound, an expanding international reach, and the same undeniable energy that first put North Florida on the map, Ivan \"El Apoca\" Justiniano continues to prove why he remains a formidable, enduring force in the industry.", socials: { ig: "elapoca" } },
